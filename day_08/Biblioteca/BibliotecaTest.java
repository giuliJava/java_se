...
public class BibliotecaTest {
	...
	public static void main(String[] args) {
		...
		// casaeditrice
		Libro ilVecchioeIlMare = new Libro("isbn1", "Il vecchio e il mare", autori.put("Ernest Hemingway", true), mondadori);
		...
		Libro ilRaccontoRealisticoconilWRW = new Libro("isbn2", "ilRaccontoRealisticoconilWRW", autori, mondadori);
